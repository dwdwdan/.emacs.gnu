...
#+begin_src emacs-lisp
  (setq org-directory (concat sync-dir "/Org")
        ...
        ;; org-startup-truncated nil means that truncate-lines will be enabled when loading an org buffer
...
*** Org find file
This function will open helm-find-files starting at the org directory
#+begin_src emacs-lisp
  (defun dan/org-find-file()
    (interactive)
    (let ((default-directory (file-name-as-directory org-directory)))
      (funcall-interactively #'helm-find-files default-directory)))
#+end_src
...
#+begin_src emacs-lisp
      (use-package org
        ...
        (my/leader
          ...
          "n f" '(dan/org-find-file :which-key "Org Find File"))
        (my/local-leader
...
#+begin_src emacs-lisp
  ...
  (defun text-mode-company-setup()
    (make-local-variable 'company-backends)
    (add-to-list 'company-backends 'company-ispell)
    (delete 'company-dabbrev company-backends))

(add-hook 'text-mode-hook 'text-mode-company-setup)
#+end_src
